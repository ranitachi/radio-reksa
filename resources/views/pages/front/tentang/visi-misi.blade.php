...
@section('title')
    <title>Visi Misi - Radio Reksa Purwakarta : 100.9 FM</title>
@endsection
@section('konten')
    <div class="row">
        <div class="span8">
        <div class="box1">
        <h2 class="c4"><div class="over1"><div class="corner1"></div><div class="txt1">Visi Misi</div><div class="corner2"></div></div></h2>
        <div class="thumb4">
            <div class="thumbnail clearfix">
                <figure class="img-polaroid"><img src="images/logo-radio.jpeg" alt="" style="width:100%"></figure>
                <div class="caption">
                    <h1 class="txt1">Visi</h1>
                    <p>
