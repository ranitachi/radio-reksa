...
@section('title')
    <title>Visi <i class="mail square icon"></i> - Radio Reksa Purwakarta : 100.9 FM</title>
@endsection
@section('konten')
    <div class="row">
        <div class="span8">
            <div class="box1">
                <h2 class="c4"><div class="over1"><div class="corner1"></div><div class="txt1">Visi Misi Radio Reksa</div><div class="corner2"></div></div></h2>
                <div class="thumb4">
                    <div class="thumbnail clearfix">
                        <figure class="img-polaroid"><img src="images/logo-radio.jpeg" alt="" style="width:100%"></figure>
                            ...
                            @if (is_null($profil))
                                <div class="page-404">
                                    <p class="txt1">404</p>
                                    <p class="txt2">VISI MISI NOT FOUND</p>
                                </div>
                            @else
                            <div class="caption">
                                <h1 class="txt1">Visi Misi Radio Reksa Purwakarta</h1>
                                {!!$profil->desc!!}
                            </div>
                            @endif
                    </div>
