...
@section('title')
	<title>Promo | Radio Reksa Purwakarta</title>
@stop
	...
	<div class="page-header">
		...
		<div class="breadcrumb-line breadcrumb-line-component">
			<ul class="breadcrumb">
				...
				<li class=""><a href="{{URL::to('/promo')}}">Promo</a></li>
    ...
    <div class="row">
        <div class="col-sm-12 col-md-12">
            ...
            <div id="data" style="padding:15px">
              <form class="form-horizontal" action="{{$id==-1 ? URL::to('promo') : URL::to('promo/'.$id) }}" method="POST" id="form-berita">
                <fieldset class="content-group">
                  ...
                  <div class="form-group">
                    <label class="control-label col-lg-2">Nama Promo</label>
                    <div class="col-lg-6">
                      <input type="text" class="form-control" placeholder="Nama Promo" name="nama_promo" id="nama_promo" autocomplete="off" value="{{($id!=-1 ? $det->nama_event : '')}}">
                    </div>
                  </div>

                  <div class="form-group">
                    <label class="control-label col-lg-2">Tanggal Promo</label>
                    <div class="col-lg-3">
